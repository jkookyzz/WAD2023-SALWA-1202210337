...
if(isset($_POST ['tinggi_badan']) && ($_POST['berat_badan'])){
...
if (!isset ($_POST ['tinggi_badan'])) {
    $message = "tinggi badan dan berat badan tidak boleh kosong";
} elseif(!isset ($_POST ['berat_badan'])){
    $message = "tinggi badan dan berat badan tidak boleh kosong";
}
...
if (isset($_POST['submit'])){
    ...
    $status = "";
    $hasil = $berat_badan/$tinggi_badan ;
    if($hasil >= 18.4) {
        $status = "Underweight";
